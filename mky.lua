...
local sector4 = tab1:CreateSector("target aim","left") --target
...
sector1:AddToggle("auto prediction",false,function(deez)
...
sector4:AddButton("target aim", function()
	...
	spawn(
		function()
			...
			placemarker.Size = Vector3.new(0.05, 0.05, 0.05)
			placemarker.Transparency = 0.1
			makemarker(placemarker, placemarker, Color3.fromRGB(67, 41, 153, 1), 0.20, 0)
		end
	)
...
sector4:AddTextbox("prediction",false,function(ferfer)
	_G.PRED = ferfer
end)


sector4:AddDropdown("aimpart",{"Head";"UpperTorso";"HumanoidRootPart", "LowerTorso"},"HumanoidRootPart",false, function(ferx)
	_G.PART = ferx
	end)


sector4:AddTextbox("target bind",false,function(narnar)
	_G.KEY = narnar
end)
